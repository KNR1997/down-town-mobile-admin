...
// hooks
import { useGoodsReceivedNotesQuery } from '@/data/grn';
// components
...
import GoodsReceivedNoteList from '@/components/grn/grn-list';
    ...
    <>
      <Card className="mb-8 flex flex-col items-center md:flex-row">
        <div className="mb-4 md:mb-0 md:w-1/4">
          <PageHeading title={t('common:sidebar-nav-item-goods-received-notes')} />
        </div>
...
GoodsReceivedNote.authenticate = {
  permissions: adminOnly,
};
GoodsReceivedNote.Layout = Layout;
